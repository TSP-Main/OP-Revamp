                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                                <div class="site-logo">
                                        <div class="col-md-12"><img src="<?php echo e(asset('img/brand-logo/pharmay-footer-logo.webp')); ?> " width="200px" height="auto" alt="Logo"></div>
                                </div>
                            </div>
                        ...
                        <div class="footer-widget footer-menu-widget clearfix">
                            ...
                            <div class="footer-menu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('web.treatment')); ?>" target="blank">A-Z Treatment</a></li>
                        ...
                        <div class="footer-widget footer-menu-widget clearfix">
                            ...
                            <div class="footer-menu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('web.conditions')); ?>" target="blank">A-Z Condition</a></li>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                        <div class="footer-widget footer-newsletter-widget">
                            ...
                            <img src="<?php echo e(asset('img/icons/payment-4.png')); ?>" alt="Payment Image">
                        </div>
                        <div class="footer-widget pt-5">
                            <a href="https://www.pharmacyregulation.org/registers/pharmacy/location/ng19%2B9qh">
                                <div>
                                    <img class="cert-auther" src="<?php echo e(asset('img/brand-logo/R.avif')); ?>" width="200px" height="auto" alt="Logo">
                                </div>
                            </a>
                        </div>
                    </div>
    ...
    <!-- FOOTER AREA END --><?php /**PATH C:\laragon\www\OP-Phill\resources\views/web/includes/footer.blade.php ENDPATH**/ ?>