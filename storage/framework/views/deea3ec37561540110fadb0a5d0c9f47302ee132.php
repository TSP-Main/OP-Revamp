                                    ...
                                    <div class="mini-cart-icon mini-cart-icon-2">
                                        <a href="#ltn__utilize-cart-menu" class="ltn__utilize-toggle">
                                            <span class="mini-cart-icon poppins-thin">
                                                ...
                                                <sup><?php echo e(Cart::count() ?? 0); ?></sup>
                                            </span>
                                        </a>
                                    </div>
                                </li>
            ...
            <div class="menu px-3 py-4" id="myMenu">
                ...
                <div class="ltn__utilize-buttons ltn__utilize-buttons-2">
                    <ul>
                        ...
                        <li>
                            <a title="My Account" href="<?php echo e(route('admin.index')); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('web.view.cart')); ?>" title="Shoping Cart">
                                <span class="utilize-btn-icon">
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="mini-cart-footer">
                <div class="mini-cart-sub-total">
                    <h5>Subtotal: <span class="mini-cart-subtotal">£<?php echo e(Cart::subTotal()); ?></span></h5>
                </div>
