...
<div class="featured-offers-area pt-5 pb-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-radius">
                    <a href="<?php echo e(url('/chronic-conditions/diabetes-medication')); ?>"><img src="img/product/chan.webp" class="card-img-top card-radius" alt="..." style="border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"></a>
            ...
            <div class="col-md-4">
                <div class="card card-radius">
                    <a href="<?php echo e(url('/pharmacy-shop')); ?>"><img src="img/product/jungle formula.webp" class="card-img-top card-radius" alt="..." style="border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"></a>
                    <div class="card-body tabPadding" style="text-align: center;">
...
<div class="ltn__product-area ltn__product-gutter  no-product-ratting pt-85 pb-70">
    <div class="container">
                    ...
                    <div class="col-lg-3--- col-md-4 col-sm-6 col-6" style="margin-bottom: 50px;">
                        <div class="ltn__product-item ltn__product-item-2 text-left">
                            <div class="product-img">
                                ...
                                <img src="<?php echo e(asset('storage/'.$val['main_image'])); ?>" alt="image">
                                ...
                                <div class="product-hover-action">
                                    <ul>
                                        <?php if($val->stock_status == 'IN'): ?>
                                        <?php if($val['product_template'] == config('constants.COUNTER_MEDICINE')): ?>
                                        <li>
                                            <a href="<?php echo e(route('web.product', ['id' => $val['slug']])); ?>">
                                                <i class="far fa-eye"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="addToCart(<?php echo e($val->id); ?>);" class="theme-btn-1 btn btn-effect-1" title="Add to Cart">
                            ...
                            <div class="product-info">
                                <h2 class="product-title"><a href="<?php echo e(route('web.product', ['id' => $val['slug']])); ?>"><?php echo e($val['title']); ?></a></h2>
                                <div class="product-price">
                                    <span>£<?php echo e($val['price']); ?></span>
                                    <del><?php echo e($val['cut_price'] ? '£'.$val['cut_price'] : NULL); ?></del>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="text-center product-btn">
            <a href="<?php echo e(route('shop')); ?>" class="theme-btn-1 btn btn-effect-3 card-radius">
                <!-- <i class="fas fa-shopping-cart"></i> -->
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-lg-6">
                ...
                <a href="<?php echo e(url('/collections/pharmacy-shop/hayfever-allergy-relief')); ?>" class="theme-btn-1 btn mt-2">Click to Buy Now</a>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        <div class="row ltn__custom-gutter--- justify-content-center">
            <div class="col-lg-4 col-sm-6">
                <div class="ltn__banner-item">
                    <div class="ltn__banner-img">
                        <a href="<?php echo e(url('collections/online-clinic/mens-health')); ?>"><img src="img/banner/Men_s_Health_400x.webp" alt="Banner Image"></a>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="ltn__banner-item">
                    <div class="ltn__banner-img">
                        <a href="<?php echo e(url('collections/online-clinic/womens-health')); ?>"><img src="img/banner/Women_s_Health_400x.webp" alt="Banner Image"></a>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="ltn__banner-item">
                    <div class="ltn__banner-img">
                        <a href="<?php echo e(url('collections/general-health')); ?>"><img src="img/banner/General_Health_400x.webp" alt="Banner Image"></a>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="modal-product-info">
                                        ...
                                        <div class="btn-wrapper">
                                            <a href="<?php echo e(route('web.view.cart')); ?>" class="theme-btn-1 btn btn-effect-1">View Cart</a>
                                            <a href="<?php echo e(route('web.checkout')); ?>" class="theme-btn-2 btn btn-effect-2">Checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php if (! $__env->hasRenderedOnce('6d54751b-2343-4267-a53c-d440491890a9')): $__env->markAsRenderedOnce('6d54751b-2343-4267-a53c-d440491890a9');
$__env->startPush('scripts'); ?>
<script>

</script>
<?php $__env->stopPush(); endif; ?>
<?php echo $__env->make('web.layouts.default', ['menu_categories' => $menu_categories], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\OP-Phill\resources\views/web/pages/home.blade.php ENDPATH**/ ?>