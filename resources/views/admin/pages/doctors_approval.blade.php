    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i
                        class="bi bi-arrow-left"></i> Back</a> | POM Orders</h1>
            <nav>
                <ol class="breadcrumb">
                                    ...
                                    <tr>
                                            ...
                                            <td style="display: inline-block;">
                                                @if(in_array($val['status'], ['Approved', 'ShippingFail']))
                                                    <span data-order_id="{{$val['id']}}"
                                                          class="btn ship_now fw-bold btn-primary no-wrap">Ship Now</span>
                                                @endif
                                        ...
                                        @if($user->hasRole('super_admin'))
                                            <th style="vertical-align: middle; text-align: center;">
                                                <button type="button" data-order-id="{{ $val['id'] }}"
                                                        class="btn btn-small bg-primary rounded-pill text-center duplicate-order">
