    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i
                        class="bi bi-arrow-left"></i> Back</a> | ShippingFail Orders</h1>
            <nav>
                <ol class="breadcrumb">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($val['email']) && isset($order_history[$val['email']]))
                                                <span
                                                    class="px-5 fw-bold">{{ $order_history[$val['email']]['total_orders'] ?? 0 }}</span>
                                            @endif
                                        </td>
                                        @php
                                            $isNewOrder = null;
                                        ...
                                        @if ($user->hasRole('super_admin'))
                                            <td>
                                                £{{ number_format((float)str_replace(',', '', $val['total_ammount']), 2) }}</td>
                                        @endif
                                        ...
                                        <td>
                                            <span
                                                class="btn fw-bold rounded-pill btn-success">{{ $val['payment_status'] ?? '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="btn fw-bold {{ $val['status'] == 'Not_Approved' ? 'btn-danger' : '' }} {{ $val['status'] == 'Approved' ? 'btn-success' : '' }} {{ $val['status'] == 'Received' ? 'btn-primary' : '' }} rounded-pill">
                                                {{ $val['status'] ?? '' }}
                                            </span>
                                        </td>
                                        <td style="display: inline-block;">
                                            @if($val['status'] == 'ShippingFail')
                                                <span data-order_id="{{$val['id']}}"
                                                      class="btn ship_now fw-bold btn-primary no-wrap rounded-pill">Ship Now</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
