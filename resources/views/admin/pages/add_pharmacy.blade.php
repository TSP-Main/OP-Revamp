...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i class="bi bi-arrow-left"></i> Back</a> | Add Pharmacy</h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card vh-100">
                    <div class="card-body">
                        <form class="row g-3 mt-3 needs-validation" method="post" action="{{ route('admin.storePharmacy') }}" novalidate>
                            @csrf
                            <input type="hidden" name="role" required value="{{ 'pharmacy'}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="tel" name="phone" value="{{  $admin['profile']['phone'] ?? old('phone') }}" class="form-control" id="phone" required>
