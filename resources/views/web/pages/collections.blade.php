                ...
                @foreach ($categories as $key => $val)
                    <div class="col-lg-4 col-sm-6 mt-5">
                        <div class="ltn__team-item ltn__team-item-3---">
                            ...
                            <div class="team-info">
                                <h4>
                                    <a href="{{ route('web.collections', ['main_category' => $main_slug,'sub_category' => isset($sub_slug) ? $sub_slug : $val['slug']]) }}">{{ $val['name'] }}</a>
                                </h4>
                                <p class="description">{{ $val['desc'] }}</p>
                            </div>
                            <div class="team-info">
                                <a href="{{ route('category.products', ['main_category' => $main_slug,'sub_category' => isset($sub_slug) ? $sub_slug : $val['slug'], 'child_category' => isset($sub_slug) ? $val['slug'] : NULL]) }}"
                                   class="btn theme-btn-1">View Products</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                                ...
                                <li>
                                    ...
                                    'sub_category' => request()->route('sub_category')
                                            ...
                                            <select class="nice-select" name="sort" onchange="this.form.submit()">
                                                ...
                                                <option
                                                    value="newest" {{ Request::get('sort') === 'newest' ? 'selected' : '' }}>
                                                    Sort by new arrivals
                                                </option>
                                                <option
                                                    value="price_low_high" {{ Request::get('sort') === 'price_low_high' ? 'selected' : '' }}>
                                                    Sort by price: low to high
                                                </option>
                                                <option
                                                    value="price_high_low" {{ Request::get('sort') === 'price_high_low' ? 'selected' : '' }}>
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-6">
                                                <div class="ltn__product-item ltn__product-item-3 text-center">
                                                    <div class="product-img">
                                                        <a href="{{ route('web.product', ['id' => $val->slug]) }}"><img
                                                                src="{{ asset('storage/'.$val->main_image)}}"
                                                                alt="product image"></a>
                            ...
                            <div class="widget ltn__menu-widget">
                                ...
                                <ul>
                                    @foreach($categories as $key => $val)
                                        @if ($is_product)
                                            <li>
                                                <a href="{{ route('category.products', ['main_category' => $main_slug,'sub_category' => isset($sub_slug) ? $sub_slug : $val['slug'], 'child_category' => isset($sub_slug) ? $val['slug'] : NULL]) }}">{{$val['name']}}
                                                    <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                        @else
                                            <li>
                                                <a href="{{ route('web.collections', ['main_category' => $main_slug,'sub_category' => isset($sub_slug) ? $sub_slug : $val['slug']]) }}">{{$val['name']}}
                                                    <span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                                        @endif
                                    @endforeach
                                </ul>
